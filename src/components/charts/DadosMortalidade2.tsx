...
import type { TabuaMortalidade } from "@/lib/services"; // Ajuste o caminho se necessário
...
interface MortalidadeD3ChartProps {
  ...
  faixas?: FaixaEtaria[]; // Opcional para evitar erros de TS se não passado
  sexos?: Sexo[];         // Opcional para evitar erros de TS se não passado
}
...
const MortalidadeD3Chart = ({ 
  ...
  useEffect(() => {
    ...
    sexosDisponiveisIds.forEach((sexoId, index) => {
      // Ordena por ano etária para a linha não ficar bagunçada
