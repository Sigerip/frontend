...
const Metodologia = () => {
  ...
  const secoes = [
    { id: "mortalidade-infantil", titulo: "Mortalidade Infantil" },
    { id: "mortalidade-geral", titulo: "Mortalidade Geral" },
    { id: "projecoes-ibge", titulo: "Projeções IBGE" },
    { id: "lee-carter", titulo: "Lee-Carter" },
    { id: "lee-miller", titulo: "Lee-Miller" },
    { id: "arima-ets", titulo: "ARIMA + ETS" },
    { id: "nnar", titulo: "ARIMA + ETS + NNAR" },
    { id: "divisao-temporal", titulo: "Divisão Temporal" },
  ...
  return (
    <div className="min-h-screen py-12 pb-[40vh]">
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
          
          {/* GUIA LATERAL (Sticky) */}
          <aside className="hidden lg:block w-64 shrink-0">
            <div className="sticky top-24 p-4 border-l-2 border-muted space-y-4">
              <p className="font-bold uppercase text-[10px] text-muted-foreground tracking-widest mb-4">
                Nesta página
              </p>
              <nav className="flex flex-col space-y-3">
                {secoes.map((secao) => (
                  <a
                    key={secao.id}
                    href={`#${secao.id}`}
                    className={`text-sm transition-all duration-300 border-l-2 -ml-[18px] pl-4 ${
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-12">
              ...
              <section id="mortalidade-infantil" className="scroll-mt-24 mb-16">
              ...
              <section id="mortalidade-geral" className="scroll-mt-24 mb-16">
              ...
              <section id="projecoes-ibge" className="scroll-mt-24 mb-16">
              ...
              {/* Modelo Lee-Carter */}
              <section id="lee-carter" className="scroll-mt-24 mb-16">
              ...
              {/* Modelo Lee-Miller */}
              <section id="lee-miller" className="scroll-mt-24 mb-16">
              ...
              <section id="arima-ets" className="scroll-mt-24 mb-16">
              ...
              <section id="nnar" className="scroll-mt-24 mb-16">
              ...
              <section id="divisao-temporal" className="scroll-mt-24 mb-16">
              ...
              <section id="metricas" className="scroll-mt-24 mb-16">
